...
import { useStore, actions, Teacher } from "@/store/dataStore";
...
export default function Teachers() {
  ...
  const [form, setForm] = useState<{ name: string; email: string; phone: string; specialization: Teacher["specialization"] | ""; experience: string }>({ name: "", email: "", phone: "", specialization: "", experience: "" });
            ...
            <SheetContent className="w-full sm:max-w-md">
              ...
              <form className="space-y-4 mt-6" onSubmit={e => {
                ...
                actions.addTeacher({
                  ...
                  email: form.email,
                  phone: form.phone,
                  specialization: (form.specialization || SPECIALIZATIONS[0]) as Teacher["specialization"],
                ...
                <div className="space-y-1.5">
                  ...
                  <Select value={form.specialization} onValueChange={v => setForm(f => ({ ...f, specialization: v as Teacher["specialization"] }))}><SelectTrigger><SelectValue placeholder="Pick" /></SelectTrigger>
