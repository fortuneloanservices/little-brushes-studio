...
import type { Student, Certificate, Payment } from "@/store/dataStore";
...
export default function Students() {
  ...
  const endingSoon = useMemo(() => {
    ...
    return students.filter(s => {
      ...
      const ms = new Date(courseEnd).getTime() - now;
...
type StudentProfileType = Student & {
  photo?: string;
  bloodGroup?: string;
  gender?: string;
  school?: string;
...
function StudentProfile({ s, certificates, payments }: { s: StudentProfileType; certificates: Certificate[]; payments: Payment[] }) {
