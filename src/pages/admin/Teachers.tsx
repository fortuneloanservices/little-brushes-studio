...
import { teachers, SPECIALIZATIONS } from "@/data/mockData";
        ...
        action={
          <Sheet open={open} onOpenChange={setOpen}>
            ...
            <SheetContent className="w-full sm:max-w-md">
              ...
              <form className="space-y-4 mt-6" onSubmit={e => { e.preventDefault(); toast.success("Teacher added!"); setOpen(false); }}>
                ...
                <div className="space-y-1.5">
                  ...
                  <Select><SelectTrigger><SelectValue placeholder="Pick" /></SelectTrigger>
                    <SelectContent>{SPECIALIZATIONS.map(s => <SelectItem key={s} value={s}>{s}</SelectItem>)}</SelectContent>
                  </Select>
                </div>
                <div className="space-y-1.5"><Label>Years of experience</Label><Input type="number" /></div>
